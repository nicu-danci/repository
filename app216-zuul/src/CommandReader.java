...
public class CommandReader 
{
    ...
    private boolean executeCommand()
    {
        ...
        else if(commandWord.equals(CommandWords.BACKPACK.word))
        {
            BackPackCommand inventory = new BackPackCommand(game);
            inventory.execute();
        }

        else if(commandWord.equals(CommandWords.FIGHT.word))
        {
